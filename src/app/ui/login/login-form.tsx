        ...
        <div className='flex-1'>
          ...
          <form action="" className='w-full'>
            <div>
              ...
              <div className='relative'>
                <input className='peer block w-full rounded-md border border-brand-primary py-[9px] pl-10 pr-10 text-sm placeholder:text-gray-400 focus:outline-brand-primary' type="email" name="email" id="email" placeholder='Enter your email address' autoComplete='email' required />
            ...
            <div className="mt-4">
              ...
              <div className='relative'>
                <input className='peer block w-full rounded-md border border-brand-primary py-[9px] pl-10 pr-10 text-sm placeholder:text-gray-400 focus:outline-brand-primary' type="password" name='password' id='password' placeholder='Enter your password' autoComplete='current-password' required minLength={6} />
            ...
            <button type='submit' className='rounded-md border border-brand-primary py-[9px] text-brand-primary hover:bg-brand-primary hover:text-surface-bg font-bold mt-6 w-full flex items-center justify-center gap-2 cursor-pointer'> {/*aria-disabled disabled>*/}
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm font-semibold">
              <span className="bg-surface-bg px-2">Or</span>
            </div>
          </div>
