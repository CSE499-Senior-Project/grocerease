...
import { EditProductSchema, type EditProductData, type MerchantProduct } from '@/types/merchant-products';
...
export default function ProductEditForm({ product, categories }: { product: MerchantProduct; categories: Category[] }) {
